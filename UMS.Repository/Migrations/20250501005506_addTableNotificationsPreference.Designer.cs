...
namespace UMS.Repository.Migrations
{
    ...
    [Migration("20250501005506_addTableNotificationsPreference")]
    partial class addTableNotificationsPreference
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UMS.Core.Entities.Student", b =>
                {
                    ...
                    b.Property<bool>("IsFirstSemester")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("UMS.Core.Entities.StudentAccounts", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UMS.Core.Entities.Registeration", b =>
                {
                    b.HasOne("UMS.Core.Entities.CourseGroup", "Group")
                        .WithMany()
                        .HasForeignKey("GroupId");

                    b.HasOne("UMS.Core.Entities.Student", null)
