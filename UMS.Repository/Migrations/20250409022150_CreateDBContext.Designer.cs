...
namespace UMS.Repository.Migrations
{
    ...
    [Migration("20250409022150_CreateDBContext")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UMS.Core.Entities.AssignmentQuiz", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UMS.Core.Entities.AssignmentQuiz", b =>
                {
                    b.HasOne("UMS.Core.Entities.Enrollment", "Enrollment")
                        .WithOne("AssignmentQuiz")
                        .HasForeignKey("UMS.Core.Entities.AssignmentQuiz", "EnrollmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
