...
namespace UMS.Repository.Migrations
{
    ...
    [Migration("20250410031546_addDepartmentInTableCourse")]
    partial class addDepartmentInTableCourse
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UMS.Core.Entities.Assignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UMS.Core.Entities.Assignment", b =>
                {
                    b.HasOne("UMS.Core.Entities.Enrollment", "Enrollment")
                        .WithOne("Assignment")
                        .HasForeignKey("UMS.Core.Entities.Assignment", "EnrollmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
